# -*- coding: utf-8 -*-
"""
Created on Mon Jan  7 10:22:25 2019
...
######################################
weight1 = weight_variable([7,14],
                         tf.truncated_normal,0.1,'w1')
#偏置
bias1 = bias_variable([14],'b1')

layer1 = tf.nn.relu(tf.matmul(xs,weight1) + bias1)
#####################################

weight2 = weight_variable([14,20],
                         tf.truncated_normal,0.1,'w2')
#偏置
bias2 = bias_variable([20],'b2')

layer2 = tf.nn.softmax(tf.matmul(layer1,weight2) + bias2)
####################################

weight3 = weight_variable([20,29],
                         tf.truncated_normal,0.1,'w3')
#偏置
bias3 = bias_variable([29],'b3')

output = tf.nn.softmax(tf.matmul(layer2,weight3) + bias3)
###################################
