...
parser.add_argument("--reload_data", default=False, type=bool, choices=[False,True], help="Whether to reload data")
...
if parse.nb_item == 0 and parse.reload_data:
    print('\033[1;33m reload data \033[0m')
    Abalone_data = AbaloneData.UCIData(parse.DataDir)
    X,Y,partial_Y = Abalone_data.createPartialData()
    ...
    print('\033[1;32m load data from pkl \033[0m')
