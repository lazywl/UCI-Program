# -*- coding: utf-8 -*-
"""
Created on Mon Jan 21 10:11:57 2019
    ...
    for i in range(cv):
        ...
        with createVar["g"+str(i)].as_default():
            with tf.variable_scope("Graph{}".format(i)):
                ...
                createVar["weight_g"+str(i)] = weight_variable([18,4],tf.truncated_normal,0.1,'w0')
                createVar["bais_g"+str(i)] = bias_variable([4],'b0')
...
print(Accu_array)
VehicleData.UCIData.save2txt(parse,Accu_array,'Network_loss4_1_2.txt')
